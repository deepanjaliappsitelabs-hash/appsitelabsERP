...
const normalize = (rec) => ({
  ...
  esi:        rec.esi        ?? 0,
  tds:        rec.tds        ?? 0,
  perDaySalary: rec.per_day_salary ?? rec.perDaySalary ?? 0,
  absentDays: rec.absent_days ?? rec.absentDays ?? 0,
  saturdayAbsentDays: rec.saturday_absent_days ?? rec.saturdayAbsentDays ?? 0,
  sundayPenaltyDays: rec.sunday_penalty_days ?? rec.sundayPenaltyDays ?? 0,
  attendanceDeduction: rec.attendance_deduction ?? rec.attendanceDeduction ?? 0,
  gross:      rec.gross      ?? 0,
